...
idCVar si_buyModeStartingCredits(	"si_buyModeStartingCredits",	"25000",			CVAR_GAME | CVAR_SERVERINFO | CVAR_INTEGER, "Amount of credits players start with in buying enable games" );
